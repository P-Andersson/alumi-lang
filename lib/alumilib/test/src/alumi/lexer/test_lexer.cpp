...
TEST_CASE("Basics")
{
	...
	SECTION("Indent")
	{
		...
		SECTION("Indented Line")
		{
			...
			REQUIRE(tokens[3] == Token((TokenType)1, TextPos(1, 3), 1));
			REQUIRE(tokens[4] == Token(TokenType::Indent, TextPos(2, 0), 3));
			REQUIRE(tokens[5] == Token((TokenType)1, TextPos(2, 3), 1));
		}
		SECTION("Indented Dedented Line")
		{
			...
			REQUIRE(tokens[2] == Token(TokenType::Indent, TextPos(1, 0), 3));
			REQUIRE(tokens[3] == Token((TokenType)1, TextPos(1, 3), 1));
			REQUIRE(tokens[4] == Token(TokenType::Indent, TextPos(2, 0), 0));
			REQUIRE(tokens[5] == Token((TokenType)1, TextPos(2, 0), 1));
		}
		SECTION("Nested Indented Line")
		{
			...
			REQUIRE(tokens[2] == Token(TokenType::Indent, TextPos(1, 0), 3));
			REQUIRE(tokens[3] == Token((TokenType)1, TextPos(1, 3), 1));
			REQUIRE(tokens[4] == Token(TokenType::Indent, TextPos(2, 0), 6));
			REQUIRE(tokens[5] == Token((TokenType)1, TextPos(2, 6), 1));
		}
		SECTION("Cliff Dedent Line")
		{
			...
			REQUIRE(tokens[3] == Token((TokenType)1, TextPos(1, 1), 1));
			REQUIRE(tokens[4] == Token(TokenType::Indent, TextPos(2, 0), 2));
			REQUIRE(tokens[5] == Token((TokenType)1, TextPos(2, 2), 1));
			REQUIRE(tokens[6] == Token(TokenType::Indent, TextPos(3, 0), 0));
			REQUIRE(tokens[7] == Token((TokenType)1, TextPos(3, 0), 1));
		}
		SECTION("Stepped Dedent Line")
		{
			...
			REQUIRE(tokens[4] == Token(TokenType::Indent, TextPos(2, 0), 6));
			REQUIRE(tokens[5] == Token((TokenType)1, TextPos(2, 6), 1));
			REQUIRE(tokens[6] == Token(TokenType::Indent, TextPos(3, 0), 3));
			REQUIRE(tokens[7] == Token((TokenType)1, TextPos(3, 3), 1));
			REQUIRE(tokens[8] == Token(TokenType::Indent, TextPos(4, 0), 0));
			REQUIRE(tokens[9] == Token((TokenType)1, TextPos(4, 0), 1));
		}
		SECTION("Cliff Dedent Line Blank Lines")
		{
			...
			REQUIRE(tokens[3] == Token((TokenType)1, TextPos(3, 3), 1));
			REQUIRE(tokens[4] == Token(TokenType::Indent, TextPos(4, 0), 6));
			REQUIRE(tokens[5] == Token((TokenType)1, TextPos(4, 6), 1));
			REQUIRE(tokens[6] == Token(TokenType::Indent, TextPos(6, 0), 0));
			REQUIRE(tokens[7] == Token((TokenType)1, TextPos(6, 0), 1));
		}
	}
	...
	SECTION("Sad Path")
	{
		...
		SECTION("Mismatched Indention")
		{
			...
			catch (const LexerFailure& e)
			{
				...
				REQUIRE(e.tokens_so_far[2] == Token(TokenType::Indent, TextPos(1, 0), 3));
				REQUIRE(e.tokens_so_far[3] == Token((TokenType)2, TextPos(1, 3), 1));
